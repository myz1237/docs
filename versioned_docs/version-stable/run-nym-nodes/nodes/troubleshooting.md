...
We currently have an API set up returning our metrics tests of the network. There are two endpoints to ping for information about your mixnode, `report` and `history`. Find more information about this in the [Mixnodes metrics documentation](/docs/stable/run-nym-nodes/nodes/mixnodes#metrics).
...
<!-- The link of interface should be removed -->
...
<!--Replace the link with a new one-->
Find more information about this in the [Mixnodes metrics documentation](/docs/stable/run-nym-nodes/nodes/mixnodes#metrics).
